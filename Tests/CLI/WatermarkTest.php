...
class WatermarkTest extends CLITest {
    ...
    public function it_should_watermark_images() {
        ...
        file_put_contents('/tmp/watermarked_test_image_1.jpg', $output_image->getImageData());

        $this->assertTrue(file_exists($output_filename));

        $expected_image = new File(__DIR__ . '/../images/expected/watermarked_test_image_1.jpg');
